...
const pedidoSchema = new mongoose.Schema({
  ...
  // Novo campo para imagens das etapas de produção
  imagensProducao: {
    type: Map,
    of: String,
    default: {} // Armazena { etapa: urlImagem }
  },
  // Campos individuais para compatibilidade
  imagemEtapaCorte: String,
  imagemEtapaCostura: String,
  imagemEtapaPersonalizacao: String,
  imagemEtapaLimpeza: String,
  imagemEtapaConcluido: String,
