    ...
    <div>
      ...
      {order && (
        <div style={{ maxWidth: 800, margin: '0 auto', background: '#fff', borderRadius: 16, boxShadow: '0 4px 24px #15616f22', padding: 32, marginBottom: 40 }}>
          ...
          <div style={{ border: '2px dashed #22a2a2', borderRadius: 14, background: '#fafdff', padding: 18, marginBottom: 18, textAlign: 'center' }}>
            ...
            {urlLayoutFinal ? (
              <img
                ...
                onClick={() => setZoomImg(urlLayoutFinal)}
              />
            ) : (
          ...
          {zoomImg && (
            <div
              style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
              onClick={() => setZoomImg(null)}
            >
              <img
                 src={zoomImg}
                 alt="Zoom"
                 style={{ maxWidth: '90vw', maxHeight: '90vh', borderRadius: 18, boxShadow: '0 8px 40px #0008' }}
